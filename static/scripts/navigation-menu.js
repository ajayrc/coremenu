...
// add more content for showing sticky footer
function addMoreContent() {
  const mainContent = document.getElementById("loremIpsum");
  mainContent.innerText += loremIpsum;
}
...
function parentNodeSelected($node) {
  ...
  const childrenContainer = $node.querySelector(
    ".navigation-menu__child-node-container"
  );
...
function submenuNodeSelected($childNode) {
  alert($childNode.querySelector(".navigation-menu__item").innerText);
}
